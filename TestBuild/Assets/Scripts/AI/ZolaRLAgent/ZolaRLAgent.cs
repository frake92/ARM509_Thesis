...
public class ZolaRLAgent : Agent
{
    ...
    #region Singleton
    public static ZolaRLAgent Instance { get; private set; }
    #endregion
    ...
    public int MAXHP = BaseStatsForZolaBoss.zolaMaxHP;
    ...
    {
        if (IsAttacking || IsMovementDisabled || PlayerHP.Instance == null) return;
    ...
    {
        if (!opponentIsDead && PlayerHP.Instance != null )
        {
    ...
    public void TakeDamage(int damage)
    {
        ...
        if (HP <= 0)
        {
            float opponentHealthPercent = PlayerHP.Instance ?
            ...
            BuildManager.Instance.gameOverText.text = "Legyőzted Zolát!";
